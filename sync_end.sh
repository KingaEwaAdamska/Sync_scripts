...
echo "Synchronizing with the local folder $LOCAL_SYNC_DIRECTORY..."
unison "$MOUNT_POINT" "$LOCAL_SYNC_DIRECTORY" -batch -confirmbigdel -auto -force "$LOCAL_SYNC_DIRECTORY"
